...
<div class="container mx-auto">
    ...
    <div class="flex justify-end mb-6">
        <a href="{{ route('admin.sustainability.create') }}" class="flex items-center gap-2 bg-emerald-500 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-emerald-600 shadow-md transition-all">
                ...
                @forelse ($sustainabilities as $s)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($s->hero_image)
                                <img src="{{ Storage::url($s->hero_image) }}" class="w-24 h-14 object-cover rounded-md shadow-sm">
                            @else
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Get started by <a href="{{ route('admin.sustainability.create') }}" class="font-medium text-emerald-600 hover:text-emerald-500">adding a new record</a>.
                            </p>
                        </td>
                    </tr>
                @endforelse
